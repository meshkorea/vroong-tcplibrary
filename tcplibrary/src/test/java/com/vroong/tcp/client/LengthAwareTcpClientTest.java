...
class LengthAwareTcpClientTest {
  ...
  void disposableTcpClient(String charsetName) throws Exception {
    final HeaderStrategy strategy = new LengthAwareHeaderStrategy('0', 4, Charset.forName(charsetName));
    final TcpServer server = new LengthAwareEchoServer(serverProperties, strategy);
